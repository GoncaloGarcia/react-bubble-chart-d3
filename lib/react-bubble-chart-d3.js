...
var BubbleChart = function (_Component) {
  ...
  _createClass(BubbleChart, [{
    ...
    value: function render() {
      return _react2.default.createElement('svg', { width: "auto", viewBox: "0 0 100 100" });
    }
  }, {
    key: 'renderChart',
    value: function renderChart() {
      var _props2 = this.props,
          ...
          legendPercentage = _props2.legendPercentage;
      ...
      var color = d3.scaleOrdinal().range(['#FFB700']);
    ...
    value: function renderBubbles(width, nodes, color) {
      var _props3 = this.props,
          graph = _props3.graph,
          data = _props3.data,
          bubbleClickFun = _props3.bubbleClickFun,
          valueFont = _props3.valueFont,
    ...
    value: function renderLegend(width, height, offset, nodes, color) {
      var _props4 = this.props,
          data = _props4.data,
          legendClickFun = _props4.legendClickFun,
          legendFont = _props4.legendFont;
